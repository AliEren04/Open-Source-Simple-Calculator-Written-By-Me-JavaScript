...
const calcTakeaway = () => {
  ...
  let SplittedTakeawaywithoutComma = SplittedResultTakeaway.replace(",", " "); 
...
const calcAdd = () => {
  ...
  let SplittedAddWithoutComma = SplittedResultAdd.replace(",", " ");
...
const calcTimes = () => {
  ...
  let TimesWithoutComma = SplittedResultTimes.replace(",", " ");
...
const calcDivide = () => {
  ...
  let SplittedDivideWithoutComma = SplittedResultDivide.replace(",", " ");
